...
catch(Exception $e)
{
	...
	{
		$d->query('CREATE TABLE entry (id INTEGER PRIMARY KEY AUTO_INCREMENT, type TEXT, subject TEXT, description TEXT, content TEXT, ip TEXT, name TEXT, comments INT, date INT, space TEXT);');
		echo "<p>Tables were created.</p>";
	}
}
